function Pet(name) { // create constructor by object Animal
    var interval = 1000;
    var pet = {
        time: 0,
        hunger: 100,
...
// check properties for gameover; if one of them === 0 then end game;
 ...
 // pet killer if u want to see ur dead pet.. brrr
